...
public class BooksController : ControllerBase
{
    ...
    public BooksController(BookService bookService, IConfiguration configuration, IValidator<SaveBookRequestDTO> bookValidator, IValidator<SaveReviewRequestDTO> reviewValidator, IValidator<RateBookRequestDTO> scoreValidator)
    {
